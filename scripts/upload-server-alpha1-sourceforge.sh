#!/usr/bin/env bash
# Upload the Lyra OS Server Alpha 1 test artifacts to SourceForge FRS.
...
echo "Destino: $REMOTE"
echo "A Alpha 1 é um build de teste não assinado e marcado como dirty."
...
echo "https://sourceforge.net/projects/lyra/files/releases/1.0/server/alpha1/"
